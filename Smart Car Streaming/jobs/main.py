...
LAGOS_COORDINATES = {"latitude": 6.5244, "longitude": 3.406448}
ABUJA_COORDINATES = {"latitude": 9.0563, "longitude": 7.4985}

# Calculate movement increments
LATITUDE_INCREMENT = (ABUJA_COORDINATES['latitude'] - LAGOS_COORDINATES['latitude']) / 100
LONGITUDE_INCREMENT = (ABUJA_COORDINATES['longitude'] - LAGOS_COORDINATES['longitude']) / 100
...
start_location = LAGOS_COORDINATES.copy()
...
def simulate_journey(producer, device_id):
    while True:
        ...
        if (vehicle_data['location'][0] >= ABUJA_COORDINATES['latitude']
                and vehicle_data['location'][1] <= ABUJA_COORDINATES['longitude']):
            print('Vehicle has reached ABUJA. Simulation ending...')
            break
